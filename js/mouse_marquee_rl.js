// Variables
const el = document.querySelector(".mouse_marquee_rl");
...
// Events
window.addEventListener("mousemove_rl", handleMouseMove);
window.addEventListener("resize_rl", handleWindowResize);
